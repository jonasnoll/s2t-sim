...
def parse_opts():
    ...
    parser.add_argument('--ssim', default=False, type=bool, help='Whether to use SSIM sampling')
    parser.add_argument('--feature', default=False, type=bool, help='Whether to use Learned Feature Space Distance sampling')
